...
def evaluate_ss(model, do_print=False):
    ...
    # TODO: change back
    ss.Div_int = (1 - 1 / par.mu_p) * ss.Y
    # ss.Div_int = ss.Y - ss.w * ss.N - ss.rk * ss.K
    assert np.isclose(1 - 1 / par.mu_p, ss.Div_int)
    ...
    par.A_target = ss.A
    # available resources for households in the steady state
...
def find_ss(model, do_print=False):
    ...
    if do_print:
        ...
        # print(f'Discrepancy in C+L = {ss.clearing_M:12.8f}')
